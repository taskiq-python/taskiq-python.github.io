import{_ as s}from"./plugin-vue_export-helper-c27b6911.js";import{o as n,c as a,a as e}from"./app-09ee9d4a.js";const t={},o=e(`<h1 id="schedule-source" tabindex="-1"><a class="header-anchor" href="#schedule-source" aria-hidden="true">#</a> Schedule source</h1><p>Schedule sources are used to get schedule for tasks. To create new <code>schedule source</code> you have to implement the <code>taskiq.abc.schedule_source.ScheduleSource</code> abstract class.</p><p>Here&#39;s a minimal example of a schedule source:</p><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code><span class="token keyword">from</span> typing <span class="token keyword">import</span> List
